              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start h-full">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    ...
                    alt="Your Company"
                  />
                  <h1 className='font-bold text-2xl'>OpenFrontend</h1>
                  {/* <img
                ...
                <div className="hidden sm:ml-6 sm:block">
                  <div className="flex space-x-4 h-full">
                    {navigation.map((item) => (
                        <div className={classNames(item.current? 'border-b-4 border-indigo-400':'border-none', 'h-full flex items-center justify-center')}>    
                        <a
                        key={item.name}
                        href={item.href}
                        className={classNames(
                          item.current ? ' text-black' : 'text-gray-400 hover:text-gray-700 hover:text-white',
            ...
            <div className="space-y-1 px-2 pt-2 pb-3">
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'border-b-4 border-indigo-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
